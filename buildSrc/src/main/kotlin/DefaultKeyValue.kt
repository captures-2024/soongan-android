...
object DefaultKeyValue {
    ...
    private const val DEFAULT_HEADER_KEY = "YOUR_KEY"
    private const val DEFAULT_HEADER_VALUE = "YOUR_VALUE"
    ...
    fun isAllowedAppleEndpoint(key: String?): String {
        if (key == null) {
            throw NullPointerException("AppleEndpoint is null.")
        }

        if (key == DEFAULT_APPLE_ENDPOINT) {
            throw IllegalArgumentException("AppleEndpoint is default.")
        }
    ...
    fun isAllowedAppleRedirectUrl(key: String?): String {
        if (key == null) {
            throw NullPointerException("AppleRedirectUrl is null.")
        }

        if (key == DEFAULT_APPLE_REDIRECT_URL) {
            throw IllegalArgumentException("AppleRedirectUrl is default.")
        }
    ...
    fun isAllowedAppleResponseUrl(key: String?): String {
        if (key == null) {
            throw NullPointerException("AppleResponseUrl is null.")
        }

        if (key == DEFAULT_APPLE_RESPONSE_URL) {
            throw IllegalArgumentException("AppleResponseUrl is default.")
        }
    ...
    fun isAllowedHeaderKey(key: String?): String {
        if (key == null) {
            throw NullPointerException("HeaderKey is null. Please input your header key")
        }

        if (key == DEFAULT_HEADER_KEY) {
            throw IllegalArgumentException("HeaderKey is default. Please input your header key")
        }
    ...
    fun isAllowedHeaderValue(key: String?): String {
        if (key == null) {
            throw NullPointerException("HeaderValue is null. Please input your header value")
        }

        if (key == DEFAULT_HEADER_VALUE) {
            throw IllegalArgumentException("HeaderValue is default. Please input your header value")
        }
