...
import com.captures2024.soongan.core.model.network.response.awards.GetFirstPrizePostResponse

internal fun GetFirstPrizePostResponse.toAwardsPostDto(): AwardsPostDto = AwardsPostDto(
    postId = this.postId,
    title = this.title,
