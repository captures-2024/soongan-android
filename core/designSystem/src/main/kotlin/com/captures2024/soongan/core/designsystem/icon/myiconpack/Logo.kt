...
public val MyIconPack.Logo: ImageVector
    get() {
        ...
        _logo = Builder(name = "Logo", defaultWidth = 37.0.dp, defaultHeight = 51.0.dp,
                viewportWidth = 37.0f, viewportHeight = 51.0f).apply {
            path(fill = SolidColor(Color(0xFFFBC304)), stroke = null, strokeLineWidth = 0.0f,
