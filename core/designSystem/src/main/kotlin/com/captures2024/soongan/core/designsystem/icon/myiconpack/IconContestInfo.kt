...
public val MyIconPack.IconContestInfo: ImageVector
    get() {
        if (_iconContestInfo != null) {
            return _iconContestInfo!!
        }
        _iconContestInfo = Builder(name = "IconContestInfo", defaultWidth = 24.0.dp, defaultHeight =
...
private var _iconContestInfo: ImageVector? = null
