...
public val MyIconPack.IconNext: ImageVector
    get() {
        if (_iconNext != null) {
            return _iconNext!!
        }
        _iconNext = Builder(name = "IconNext", defaultWidth = 20.0.dp, defaultHeight = 16.0.dp,
                viewportWidth = 20.0f, viewportHeight = 16.0f).apply {
...
private var _iconNext: ImageVector? = null
