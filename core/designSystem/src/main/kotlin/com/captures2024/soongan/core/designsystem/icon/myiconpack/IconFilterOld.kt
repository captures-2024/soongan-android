...
public val MyIconPack.IconFilterOld: ImageVector
    get() {
        ...
        _iconFilterOld = Builder(name = "IconFilterOld", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF252525)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.9922f, 20.0f)
                lineTo(10.9922f, 20.0f)
                lineTo(10.9965f, 14.0f)
                lineTo(8.9996f, 16.0f)
                lineTo(8.0f, 15.0f)
                lineTo(12.0f, 11.0f)
                lineTo(16.0f, 15.0f)
                close()
...
private var _iconFilterOld: ImageVector? = null
