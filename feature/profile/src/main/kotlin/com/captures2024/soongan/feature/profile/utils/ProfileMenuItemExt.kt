...
fun ProfileBtmShtMenuItem.textId() = when (this) {
...
fun ProfileBtmShtMenuItem.color() = if (this == ProfileBtmShtMenuItem.SIGN_OUT) SGColor.negative else SGColor.black

fun ProfileBtmShtMenuItem.icon() = when (this) {
